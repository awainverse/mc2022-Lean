...
hljs.registerLanguage("lean",function(){
	...
	return function(e){
		var n
			={
				keyword:"theorem|10 lemma|10 definition def class structure instance example inductive coinductive axiom axioms hypothesis constant constants universe universes variable variables parameter parameters begin end import open theory prelude renaming hiding exposing calc  match do  by let in extends fun assume #check #eval #reduce #print",
				...
				end:":=",excludeEnd:!0,contains:[{className:"keyword",begin:/extends/},
				e.inherit(e.TITLE_MODE,{begin:/[A-Za-z_][\\w\u207F-\u209C\u1D62-\u1D6A\u2079\']*/}),{className:"params",begin:/[([{]/,end:/[)\]}]/,endsParent:!1,keywords:n},{className:"symbol",begin:/:/,endsParent:!0}],keywords:n};return{name:"lean",keywords:n,contains:[e.QUOTE_STRING_MODE,e.NUMBER_MODE,t,a,{className:"doctag",begin:"/-[-!]",end:"-/"},s,{className:"meta",begin:"@\\[",end:"\\]"},{className:"meta",begin:"^attribute",end:"$"},{begin:/⟨/}]}}}());
